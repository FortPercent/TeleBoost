...
CHECKPOINT_PATH=/nvfile-heatstorage/yxy/code/Teletron/debug/ckpt/origin/wan_prone10_step5000
TARGET_CKPT_PATH="/nvfile-heatstorage/yxy/zbk/data/ckpt"

python  examples/wan/convert_light_wan.py  \
    --hf-ckpt-path ${HF_CKPT_PATH} \
