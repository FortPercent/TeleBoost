...
# Reference asset directory for first-last-frame test prompts.
FLF2V_REF_DIR = os.environ.get('FLF2V_REF_DIR', '/path/to/flf2v_test_assets')
...
PROMPT_CONFIGS = {
    "flf2v_02": {
        ...
        "ref_images": {
            "0": f"{FLF2V_REF_DIR}/FL_1_F_building.png",
            "-1": f"{FLF2V_REF_DIR}/FL_1_L_building.png"
        }
    },
    "flf2v_00": {
        ...
        "ref_images": {
            "0": f"{FLF2V_REF_DIR}/mixkit-girl-eating-a-glazed-donut-with-a-milkshake-40831-hd-ready_0.png",
            "-1": f"{FLF2V_REF_DIR}/mixkit-girl-eating-a-glazed-donut-with-a-milkshake-40831-hd-ready_249.png"
        }
    },
    "flf2v_01": {
        ...
        "ref_images": {
            "0": f"{FLF2V_REF_DIR}/mixkit-woman-walking-on-beach-towards-boulders-1012-hd-ready_0.png",
            "-1": f"{FLF2V_REF_DIR}/mixkit-woman-walking-on-beach-towards-boulders-1012-hd-ready_249.png"
        }
    },
    "FL_motor": {
        ...
        "ref_images": {
            "0": f"{FLF2V_REF_DIR}/motor_F.jpg",
            "-1": f"{FLF2V_REF_DIR}/motor_L.jpg",
        },
    },
    "FL_teapot": {
        ...
        "ref_images": {
            "0": f"{FLF2V_REF_DIR}/FL_7_F_teapot.png",
            "-1": f"{FLF2V_REF_DIR}/FL_7_L_teapot.png",
        },
      },
}