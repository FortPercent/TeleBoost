...
class CausalFPSInferencePipeline(torch.nn.Module):
    def __init__(
        ...
        self.generator = WanFPSWrapper(
            **getattr(args, "model_kwargs", {}), is_causal=True) if generator is None else generator
        for module in [self.generator.model]:
    ...
    def inference(
        ...
        for current_num_frames in all_num_frames:
            ...
            print('attention_vis_index:', self.kv_cache_pos[0]["attention_vis_index"])
            ...
            for _, t in enumerate(tqdm(sample_scheduler.timesteps)):
                ...
                with torch.no_grad():
                    # self.kv_cache_pos = move_kv_cache_to_gpu(self.kv_cache_pos)
                    # self.kv_cache_neg = move_kv_cache_to_cpu(self.kv_cache_neg)
                    ...
                    # self.kv_cache_pos = move_kv_cache_to_cpu(self.kv_cache_pos)
                    # self.kv_cache_neg = move_kv_cache_to_gpu(self.kv_cache_neg)
            ...
            output[:, result[global_chunk_index]] = latents
