...
if hasattr(config, 'denoising_step_list'):
    ...
    pipeline_chunk_1 = CausalFPSInferencePipeline(config, device=device, device_cond="cuda:1", device_uncond="cuda:0", save="latents_chunk1.pt")
    pipeline_chunk_2 = CausalFPSInferencePipeline(config, device=device, device_cond="cuda:3", device_uncond="cuda:2", save="latents_chunk2.pt")
    pipeline_chunk_3 = CausalFPSInferencePipeline(config, device=device, device_cond="cuda:5", device_uncond="cuda:4", save="latents_chunk3.pt")
    pipeline_chunk_4 = CausalFPSInferencePipeline(config, device=device, device_cond="cuda:7", device_uncond="cuda:6", save="latents_chunk4.pt")
