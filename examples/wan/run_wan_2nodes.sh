...
export PYTHONPATH=$PYTHONPATH:/nvfile-heatstorage/teleai-infra/qiuyang/Megatron-LM
# TODO, change to your own path
# export PYTHONPATH=$PYTHONPATH:/nvfile-heatstorage/yxy/code/Megatron_060
export PYTHONPATH=$PYTHONPATH:/nvfile-heatstorage/teleai-infra/qiuyang/refactor/Teletron
...
CHECKPOINT_PATH=/nvfile-heatstorage/teleai-infra/qiuyang/
...
torchrun ${DISTRIBUTED_ARGS[@]} examples/wan/pretrain_wan.py \
    ...
    ${MODEL_PARALLEL_ARGS[@]} \
    ${DATA_ARGS[@]}    \
    ${EVAL_AND_LOGGING_ARGS[@]} 2>&1 | tee wan_Node_rank_${NODE_RANK}.log
