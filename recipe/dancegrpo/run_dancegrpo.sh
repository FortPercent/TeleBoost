...
HYDRA_FULL_ERROR=1 python3 -m recipe.dancegrpo.main_dancegrpo \
    ...
    actor_rollout_ref.model.vae_model_path='/root/Wan2___1-T2V-1___3B/Wan2.1_VAE.pth' \
    ...
    reward_model.model.path='/nvfile-heatstorage/chatrl/public/models/Qwen2.5-VL-72B-Instruct' \
