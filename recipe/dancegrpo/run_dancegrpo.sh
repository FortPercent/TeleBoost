...
HYDRA_FULL_ERROR=1 python3 -m recipe.dancegrpo.main_dancegrpo \
    ...
    actor_rollout_ref.model.path='/root/models/Wan2.2-T2V-A14B' \
    +actor_rollout_ref.model.wan_version='wan22' \
    actor_rollout_ref.model.vae_model_path='/root/models/Wan2.2-T2V-A14B/Wan2.1_VAE.pth' \
    ...
    reward_model.model.path='/root/models/Qwen2.5-VL-7B-Instruct' \
