...
HYDRA_FULL_ERROR=1 python3 -m recipe.dancegrpo.main_dancegrpo \
    ...
    actor_rollout_ref.model.path='/gfs/space/chatrl/users/wxe/Wan-AI/Wan2.2-T2V-A14B' \
    +actor_rollout_ref.model.wan_version='wan22' \
    actor_rollout_ref.model.vae_model_path='/gfs/space/chatrl/users/wxe/Wan-AI/Wan2.2-T2V-A14B/Wan2.1_VAE.pth' \
