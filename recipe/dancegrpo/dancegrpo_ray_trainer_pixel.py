...
# import-verl: upstream's compute_timing_metrics requires LM-shape `responses`;
# RayDanceGRPOTrainer module exposes a diffusion-friendly variant.
from .dancegrpo_ray_trainer import compute_timing_metrics
