#!/usr/bin/env bash
# =============================================================================
# 4×H800 80GB smoke test (14B Wan2.2 + flow-grpo SDE) — derived from run_dancegrpo_single_4gpu_smoke.sh.
#
...
CKPTS_DIR=${CKPTS_DIR:-"/tmp/dancegrpo_smoke_flowgrpo_ckpt"}
...
export TENSORBOARD_DIR=/tmp/dancegrpo_smoke_flowgrpo_tb/${exp_name}
