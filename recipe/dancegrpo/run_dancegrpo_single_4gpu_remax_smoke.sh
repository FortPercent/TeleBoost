#!/usr/bin/env bash
# =============================================================================
# 4×H800 80GB smoke test (14B Wan2.2 + REMAX advantage estimator) — derived from run_dancegrpo_single_4gpu_smoke.sh.
#
...
CKPTS_DIR=${CKPTS_DIR:-"/tmp/dancegrpo_smoke_remax_ckpt"}
...
export TENSORBOARD_DIR=/tmp/dancegrpo_smoke_remax_tb/${exp_name}
