...
exp_name=${project_name}_8gpu_5step_run_dancegrpo_joint_8gpu_5step_${TIMESTAMP}
...
CKPTS_DIR=${CKPTS_DIR:-"/tmp/dancegrpo_8gpu_ckpt"}
TRAIN_FILE=${TRAIN_FILE:-"/tmp/processed_wan_prompt_real.json"}
TEST_FILE=${TEST_FILE:-"/tmp/processed_wan_prompt_real.json"}
# export CUDA_VISIBLE_DEVICES=0,1,2,3

export TENSORBOARD_DIR=/gfs/platform/public/infra/Dance-grpo/tensorboard_log/${exp_name}
...
HYDRA_FULL_ERROR=1 python3 -m recipe.dancegrpo.main_dancegrpo \
    ...
    reward_model.joint.models.aesthetic.extra_config.clip_model_path='/gfs/platform/public/infra/models/ViT-L-14.pt' \
    reward_model.joint.models.aesthetic.extra_config.aes_model_path='/gfs/platform/public/infra/models/sa_0_4_vit_l_14_linear.pth' \
    reward_model.joint.models.raft.model_path="/gfs/platform/public/infra/models/raft-things.pth" \
    reward_model.joint.models.videoclip.model_path="/gfs/platform/public/infra/models/VideoCLIP-XL.bin" \
    reward_model.joint.models.videophy.model_path="/gfs/platform/public/infra/models/videocon_physics" \
