#!/usr/bin/env bash
# =============================================================================
# 4×H800 80GB smoke test (14B Wan2.2 + joint 4-reward)
#
# Derived from run_dancegrpo_single_4gpu_smoke.sh + 1p3B_joint variant, swapping reward_model into joint mode
...
CKPTS_DIR=${CKPTS_DIR:-"/tmp/dancegrpo_smoke_joint_ckpt"}
...
export TENSORBOARD_DIR=/tmp/dancegrpo_smoke_joint_tb/${exp_name}
