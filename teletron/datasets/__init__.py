...
# teletron.utils.config imports teletron.datasets.utils, which imports the
# datasets package; eagerly importing FakeDataset / DATASETS here re-enters
# teletron.utils before its __init__ finishes.
...
def __getattr__(name):
    """PEP 562 lazy attribute access — resolves once teletron.utils is ready."""
    if name == "FakeDataset":
