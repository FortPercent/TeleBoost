...
class DataloaderMixin:
    ...
    def build_pretraining_data_loader(self, dataset, consumed_samples, data_parallel_rank=None, data_parallel_size=None):
        ...
        batch_sampler = build_sampler(sampler_config, dataset=dataset, consumed_samples=consumed_samples * data_parallel_size // args.dit_world_size, micro_batch_size=args.micro_batch_size, data_parallel_rank=data_parallel_rank, data_parallel_size=data_parallel_size)
