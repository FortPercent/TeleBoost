...
from teleboost.core.distributed import DistributedDataParallel as DDP
...
from teleboost.train.utils import (
...
from teleboost.core.parallel_state import get_transformer_model_group, get_world_group
from teleboost.train.dataloader import DataloaderMixin
from teleboost.models.build import build_model
from teleboost.train.checkpoint import CheckPointMixin, unwrap_model, ensure_directory_exists, EMAModel
from teleboost.train.lr_scheduler import SchedulerMixin
from teleboost.train.telelogger import TeleLoggerMixin
from logging import getLogger
from teleboost.datasets.build import build_train_valid_test_datasets
from teleboost.core.distributed.distributed_encoder import DistDataProducer
from teleboost.train.consumer_dataloader import create_batch_loader
...
class Trainer(CheckPointMixin, SchedulerMixin, DataloaderMixin, TeleLoggerMixin):
    def __init__(
        ...
        self.logger = logging.getLogger(f"teleboost.{role_tag}")
    ...
    def pretrain(
        ...
        if args.distributed_vae:
            ...
            from teleboost.core.parallel_state import get_comm_pair
