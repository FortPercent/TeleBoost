...
from teleboost.core.distributed.base_encoder import BaseEncoder
...
from teleboost.models.teleai.models.dit.diffsynth_wan_video_vae import (
    WanVideoVAE as DiffSynthWanVideoVAE,
    WanVideoVAE38 as DiffSynthWanVideoVAE38,
)
from teleboost.models.teleai.teleai_encoder_utils import (
    get_context,
...
from teleboost.utils import get_args, set_config
...
def _dump_model_state_dict(model, model_name, torch_dtype):
    ...
    out_path = os.path.join(out_dir, f"teleboost_{model_name}_{dtype_label}.pth")
    try:
