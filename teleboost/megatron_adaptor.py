...
def exe_adaptation():
    ...
    from teleboost.core.parallel_state import initialize_model_parallel_decorators
    from teleboost.core.parallel_state import destroy_model_parallel_wrapper
    from teleboost.core.parallel_state import (get_tensor_context_parallel_group, 
